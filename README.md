...
3. **The "Carry" Rule**: If a highly-rated player and a low-rated player team up and WIN, the system knows the highly-rated player did the heavy lifting. Therefore, the higher player earns _more_ points, and the lower player earns _fewer_. If they LOSE, the higher player failed to carry the team, so they lose _more_ points, while the beginner is forgiven and loses _fewer_.
